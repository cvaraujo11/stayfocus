...
export default function AutoconhecimentoPage() {
  ...
  const { modoRefugio, loading, error, setupRealtimeSync } = useAutoconhecimentoStore()
    ...
    <Container>
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6 overflow-x-auto">
        {(Object.keys(tituloAbas) as Array<keyof typeof tituloAbas>).map((aba) => (
          <button
            key={aba}
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap rounded-t-lg transition-colors ${abaSelecionada === aba
