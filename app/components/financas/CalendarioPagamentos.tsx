...
export function CalendarioPagamentos() {
  ...
  const handleAdicionarPagamento = async () => {
    ...
    await adicionarPagamentoRecorrente(
      novoPagamento.descricao,
      novoPagamento.valor,
      novoPagamento.dataVencimento,
      novoPagamento.categoriaId
        ...
        {pagamentosOrdenados.length > 0 ? (
          pagamentosOrdenados.map(pagamento => {
            ...
            return (
              <div
                key={pagamento.id}
                className={`border rounded-lg overflow-hidden ${pagamento.pago
              ...
              >
                <div
                  className={`flex items-center justify-between p-3 ${pagamento.pago
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <button
                      ...
                      className={`p-1 rounded-full ${pagamento.pago
